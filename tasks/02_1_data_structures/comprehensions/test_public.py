...
def assert_comprehension_structure(func: Callable[..., tp.Any], comprehension_specific_opcode: str) -> None:
    assert testlib.functions.is_bytecode_op_used(func, comprehension_specific_opcode), "You should use comprehension"
...
def test_get_unique_page_ids_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_unique_page_ids, 'SET_ADD')
...
def test_get_unique_page_ids_visited_after_ts_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_unique_page_ids_visited_after_ts, 'SET_ADD')
...
def test_get_unique_user_ids_visited_page_after_ts_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_unique_user_ids_visited_page_after_ts, 'SET_ADD')
...
def test_get_events_by_device_type_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_events_by_device_type, 'LIST_APPEND')
...
def test_get_region_ids_with_none_replaces_by_default_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_region_ids_with_none_replaces_by_default, 'LIST_APPEND')
...
def test_get_region_id_if_not_none_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_region_id_if_not_none, 'LIST_APPEND')
...
def test_get_keys_where_value_is_not_none_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_keys_where_value_is_not_none, 'LIST_APPEND')
...
def test_get_record_with_none_if_key_not_in_keys_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_record_with_none_if_key_not_in_keys, 'MAP_ADD')
...
def test_get_record_with_key_in_keys_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_record_with_key_in_keys, 'MAP_ADD')
...
def test_get_keys_if_key_in_keys_structure() -> None:
    ...
    assert_comprehension_structure(comp.get_keys_if_key_in_keys, 'SET_ADD')
